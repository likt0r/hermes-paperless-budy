/**
 * System prompt: establishes the LLM's role and provides the document context.
 * Sent once as the first message in the chat conversation.
 */
...
/**
 * Task 1: Extract the document title.
 */
...
/**
 * Task 2: Extract a short factual summary.
 */
...
/**
 * Task 3: Extract the document issue date and language.
 */
...
/**
 * Task 4: Select tags from the allowed list.
 */
...
/**
 * Task 5: Select the document type from the allowed list.
 */
...
/**
 * Task 6: Identify the correspondent (the other party, not Benjamin Werner).
 */
